...
OUTPUT_FILENAME = "Global.list"

# 主规则源：你要精简的 Global 规则
MAIN_RULESET = {
    "name": "Sukka Global",
    "url": "https://raw.githubusercontent.com/SukkaLab/ruleset.skk.moe/refs/heads/master/List/non_ip/global.conf",
}

# 用于从 Global 中剔除的规则集
# 例如你有单独的 Google / Twitter 策略组，那么这些规则就没必要再留在 Global 里
EXCLUDE_RULESETS = [
    {
        "name": "Google",
        "url": "https://raw.githubusercontent.com/Yronos/ProxyConfig/refs/heads/main/rules/lite/Google.list",
    },
    {
        "name": "Twitter",
        "url": "https://raw.githubusercontent.com/Yronos/ProxyConfig/refs/heads/main/rules/lite/Twitter.list",
    },
    {
        "name": "Meta",
        "url": "https://raw.githubusercontent.com/Yronos/ProxyConfig/refs/heads/main/rules/lite/Meta.list",
    },
    {
        "name": "GitHub",
        "url": "https://raw.githubusercontent.com/Yronos/ProxyConfig/refs/heads/main/rules/lite/GitHub.list",
    },
    {
        "name": "Amazon",
        "url": "https://raw.githubusercontent.com/Yronos/ProxyConfig/refs/heads/main/rules/surge/Amazon.list",
    },
    {
        "name": "Cloudflare",
        "url": "https://raw.githubusercontent.com/Yronos/ProxyConfig/refs/heads/main/rules/surge/Cloudflare.list",
    },
    {
        "name": "Discord",
        "url": "https://raw.githubusercontent.com/Yronos/ProxyConfig/refs/heads/main/rules/lite/Discord.list",
    },
    {
        "name": "Forum",
...
def main():
    try:
        rules, stats, exclude_results = generate_lite_global()
