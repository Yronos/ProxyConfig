...
OUTPUT_FILENAME = "reject-no-drop.list"

# 源文件路径（支持本地路径或 HTTP/HTTPS URL）
SOURCE_FILE = "https://raw.githubusercontent.com/SukkaLab/ruleset.skk.moe/refs/heads/master/Clash/non_ip/reject-no-drop.txt"
...
def write_output(
    ...
    header = [
        f"# Generated by filter_reject-no-drop.py",
