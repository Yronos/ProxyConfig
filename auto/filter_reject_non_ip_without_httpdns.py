...
DOMAINSET_URL = "https://ruleset.skk.moe/List/non_ip/reject.conf"
...
# 输出文件名 (留空则自动生成)
OUTPUT_FILE = "Reject_without_HTTPDNS.list"
...
def generate_output_filename(ruleset_names: List[str], domainset_name: str) -> str:
    ...
    return "-".join(ruleset_names) + "-" + domainset_name + "-uncovered.list"
