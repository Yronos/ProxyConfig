...
OUTPUT_FILENAME = "Streaming.list"

# 源文件路径（支持本地路径或 HTTP/HTTPS URL）
SOURCE_FILE = "https://raw.githubusercontent.com/SukkaLab/ruleset.skk.moe/refs/heads/master/List/non_ip/stream.conf"
...
def write_output(
    ...
    header = [
        f"# Generated by filter_streaming.py",
