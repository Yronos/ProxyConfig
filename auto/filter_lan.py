...
OUTPUT_FILENAME = "Lan.list"

# 主规则源：你要精简的 Lan 规则
MAIN_RULESET = {
    "name": "Sukka Lan",
    "url": "https://raw.githubusercontent.com/SukkaLab/ruleset.skk.moe/refs/heads/master/List/non_ip/lan.conf",
}

# 用于从 Lan 中剔除的规则集
# 例如你有单独的 Google / Twitter 策略组，那么这些规则就没必要再留在 Lan 里
EXCLUDE_RULESETS = []
...
def main():
    try:
        rules, stats, exclude_results = generate_lite_lan()
