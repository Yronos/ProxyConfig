...
OUTPUT_FILENAME = "Discord.list"

# 源文件路径（支持本地路径或 HTTP/HTTPS URL）
SOURCE_FILE = "https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/refs/heads/master/rule/Surge/Discord/Discord.list"
...
def write_output(
    ...
    header = [
        f"# Generated by filter_discord.py",
