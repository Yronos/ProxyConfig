...
OUTPUT_FILENAME = "Domestic.list"

# 主规则源：你要精简的 Domestic 规则
MAIN_RULESET = {
    "name": "Sukka Domestic",
    "url": "https://raw.githubusercontent.com/SukkaLab/ruleset.skk.moe/refs/heads/master/List/non_ip/domestic.conf",
}

# 用于从 Domestic 中剔除的规则集
# 例如你有单独的 Google / Twitter 策略组，那么这些规则就没必要再留在 Domestic 里
EXCLUDE_RULESETS = [
    {
        "name": "Lite Bilibili",
        "url": "https://raw.githubusercontent.com/Yronos/ProxyConfig/refs/heads/main/rules/lite/Bilibili.list",
    },
    {
        "name": "ForceDirect",
        "url": "https://raw.githubusercontent.com/Yronos/ProxyConfig/refs/heads/main/rules/ForceDirect.list",
    },
]
...
def write_output(rules: list, stats: dict, exclude_results: list):
    ...
    if WRITE_HEADER:
        lines.extend(
            [
                "# Generated by filter_domestic.py",
...
def main():
    try:
        rules, stats, exclude_results = generate_lite_domestic()
