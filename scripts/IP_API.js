...
function Timezone_ValidCheck(para) {
  return para ? para : timezone0;
}

function Flag_ValidCheck(code) {
...
// 获取各项数据
var flag = Flag_ValidCheck(obj["countryCode"]);
var city = City_ValidCheck(obj["city"]);
var ip = obj["query"];
var isp = ISP_ValidCheck(obj["org"] || obj["as"] || obj["isp"]);
